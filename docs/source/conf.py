...
# zindi_load_default documentation build
...
from zindi_load_default import __version__ as release

# -- Project information -----------------------------------------------------

project = "zindi_load_default"
copyright = "2020, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "zindi_load_defaultdoc"
...
latex_documents = [
    (
        master_doc,
        "zindi_load_default.tex",
        "zindi_load_default Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "zindi_load_default",
        "Project zindi_load_default codebase.",
        "Data-Science",
    )
]
